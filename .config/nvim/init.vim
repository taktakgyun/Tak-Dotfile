...
nnoremap <silent><nowait> <Leader>t  :<C-u>tabnew<CR>
nnoremap <silent><nowait> <Leader>n  :<C-u>bn<CR>
nnoremap <silent><nowait> <Leader>p  :<C-u>bp<CR>

" ~~~highlight Rust-analyzer
nnoremap <silent><nowait> <leader>h  :<C-u>:hi CocInlayHint ctermbg=53 <CR>
...
set encoding=utf-8
set fileencodings=utf-8,euc-kf
set fencs=ucs-bom,utf-8,euc-kf
set showmatch
